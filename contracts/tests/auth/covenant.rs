...
//!
//! The slot widths here are dictated by `CutSlots` in the covenant, so this lives beside
//! the contract rather than in `storm-tree`: change one and the other must follow.
