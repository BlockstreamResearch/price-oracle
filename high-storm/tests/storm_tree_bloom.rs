...
//!
//! This emits the raw Bloom: root, aggregate signature, branch, and the monotree proof.
//! Packing it into the covenant's slots is the contract's business and lives there, in
//! `contracts/tests/auth/covenant.rs`.
