...
#[cfg(not(test))]
pub(super) const RECONNECT_INTERVAL: Duration = Duration::from_secs(3);
#[cfg(test)]
pub(super) const RECONNECT_INTERVAL: Duration = Duration::from_millis(50);
...
pub(super) const CONTROL_MESSAGE_RATE_WINDOW: Duration = Duration::from_secs(10);
pub(super) const CONTROL_MESSAGE_RATE_CAPACITY: usize = 64;
